...
from Blockchain.Backend.util.util import int_to_little_endian, bytes_needed, decode_base58, little_endian_to_int, encode_varint, hash256, read_varint
...
PRIVATE_KEY = '49190780511027130330696391407676493615547676779410269489938157581909610769221'
