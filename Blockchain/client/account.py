...
class account:
    def createKeys(self):
        ...
        #define the prefix of the public key. Written in bytes. big refers to "big indian" which writes the code from left to right. little would be the opposite. Then create public key
        if y_point.num % 2 == 0:
